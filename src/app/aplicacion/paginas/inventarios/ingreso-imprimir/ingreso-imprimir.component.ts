...
@Component({
  ...
  styleUrls: ['./ingreso-imprimir.component.scss']
})
export class IngresoImprimirComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<IngresoImprimirComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
